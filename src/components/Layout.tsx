...
const Layout = ({ children }: LayoutProps) => {
  return (
    <div className="flex flex-col min-h-screen bg-blue-50 text-green-800">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-yellow-200">
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-red-200 py-6 text-center text-gray-500 text-sm">
